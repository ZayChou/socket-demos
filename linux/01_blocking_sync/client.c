/*
 * linux/01_blocking_sync/client.c
 *
 * Blocking synchronous TCP echo client.
 *
 * Connects to the server, sends three messages ("hello", "ping", "bye"),
 * verifies each echo, then disconnects.
 */

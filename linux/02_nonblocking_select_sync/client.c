/*
 * linux/02_nonblocking_select_sync/client.c
 *
 * Non-blocking select()-based TCP echo client.
 *
 * Connects, sends messages, verifies echoes, then sends "bye".
 * Uses the same protocol as the blocking demo so any server can handle it.
 */
